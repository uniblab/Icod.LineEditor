param([ValidateSet('Debug','Staging','Release')][string]$Configuration='Release',[string]$GitHubOutputPath='')
...
if($hasSolution){
    ...
    $portableSolutionPath=[System.IO.Path]::GetRelativePath($repositoryRoot,$solutionPath).Replace([System.IO.Path]::DirectorySeparatorChar,'/')
}
